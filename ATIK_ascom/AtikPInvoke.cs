...
namespace ATIKCAM
{
    ...
    public enum HotPixelSensitivity { HPS_HIGH, HPS_MEDIUM, HPS_LOW };
    ...
    public static class AtikPInvoke
    {
        ...
        [DllImport(DLLPath)]
        public static extern unsafe int ArtemisGetImageBuffer(IntPtr handle, ushort* pixels, int nPixel);
        ...
        [DllImport(DLLPath)]
        public static extern int ArtemisHotPixelAutoRemoval(IntPtr handle, bool on);
        [DllImport(DLLPath)]
        public static extern int ArtemisHotPixelAdvancedRemoval(IntPtr handle, bool on, bool darkFrame, bool checkForAdjacentHotPixels, int hps);
        [DllImport(DLLPath)]
        public static extern int ArtemisHotPixelAdvancedCalculateHotPixels(IntPtr handle, float exposureLength);
        [DllImport(DLLPath)]
        public static extern int ArtemisHotPixelAdvancedCalculcationComplete(IntPtr handle, out bool calcualtionComplete);

...
namespace ASCOM.ATIKVS.Camera
{
    ...
    public partial class SetupDialogForm : Form
    {
        ...
        private void CmdOK_Click(object sender, EventArgs e) // OK button event handler
        {
            ...
            CameraHardware.SetOffset( int.Parse(txtOffset.Text));
            tl.LogMessage("Setup OK", $"New configuration values - offset: {txtOffset.Text}");
            Close();
        ...
        private void InitUI()
        {
            ...
            // populate offset text
         
            txtOffset.Text = CameraHardware.offset.ToString();

...
//
// ASCOM Camera driver for ATIKVS
//
...
namespace ASCOM.ATIKVS.Camera
{
    ...
    //
    // Your driver's DeviceID is ASCOM.ATIKVS.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.ATIKVS.Camera
    // The COM ClassInterface/None attribute prevents an empty interface called _ATIKVS from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("210614d5-a6ce-43a6-a5ed-adbf9be00bf2")]
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ATIKVS"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Camera()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ATIKVS.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.ATIKVS.Camera", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
            ...
            try
            {
                ...
                _ = Task.Run(() =>
                {
                    try
                    {
                        ...
                        CameraHardware.SetConnected(uniqueId, true);
                        connectedState = true;
            ...
            set
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        CameraHardware.SetConnected(uniqueId, false);

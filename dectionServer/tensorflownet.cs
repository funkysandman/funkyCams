...
namespace TensorFlowNET.Examples
{
    public class ObjectDetection
    {
        ...
        public bool Run()
        {
            ...
            imgArr = ReadTensorFromImageFile( "input.jpg");
        ...
        {
            // get pbtxt items
            PbtxtItems pbTxtItems = PbtxtParser.ParsePbtxtFile( "object-detection.pbtxt");

...
Public Class frmIS
    ...
    Public Sub loadMasterDark()
        ...
        Try
            ...
            ReDim dark(fStream.Length)
            ReDim uintDark(fStream.Length / 2)
            For i = 0 To fStream.Length - 1
                dark(i) = bReader.ReadByte()
                'dark(i) = dark(i) * multiplier
            Next
            fStream.Close()
            Buffer.BlockCopy(dark, 0, uintDark, 0, dark.Length)
    ...
    Private Function gotBuffer(arg As IFrameQueueBuffer) As FrameQueuedResult
        ...
        Dim uintImg(arg.ActualDataSize / 2) As UShort
        ...
        If cbUseDarks.Checked And lblDayNight.Text = "night" Then
            ...
            For x = 0 To iWidth - 1
                For y = 0 To iHeight - 1
                    pixelValue = uintImg(iWidth * y + x)
                    If x = iWidth - 1 Then
                        neigborPixelValue = uintImg(iWidth * y + x - 1)
                    Else
                        neigborPixelValue = uintImg(iWidth * y + x + 2)
                    End If

                    dPixelValue = uintDark(y * iWidth + x)
                    ...
                    uintImg(iWidth * y + x) = newPixelValue
                    ' End If
                    ' uintImg(iWidth * y + x) = dPixelValue
        ...
        If m_pics Is Nothing Then
            m_pics = New frmMaster.RingBitmap(5)
        End If

        m_pics.FillNextBitmap(outImage, iWidth, iHeight, iWidth * iHeight * 3)
    ...
    Private Sub initIS()
        ...
        Me.IcImagingControl1.DeviceState = "<device_state libver=""3.5"" filemajor=""1"" fileminor=""0"">" & vbLf & "    <device name=""DBK 33UX178"" base_name=""DBK 33UX178"" unique_name=""DBK 33UX178 48710122"">" & vbLf & "        <videoformat>Y16 (3072x2048)</videoformat>" & vbLf & "        <fps>1.</fps>" & vbLf & "        <fliph>0</fliph>" & vbLf & "        <vcdpropertyitems>" & vbLf & "            <item guid=""{8E972004-3B94-4AA4-A899-65F6A1432713}"" name=""Startup Behavior"" />" & vbLf & "            <item guid=""{284C0E06-010B-45BF-8291-09D90A459B28}"" name=""Brightness"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""240"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{284C0E08-010B-45BF-8291-09D90A459B28}"" name=""Hue"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{284C0E09-010B-45BF-8291-09D90A459B28}"" name=""Saturation"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E08}"" value=""125."" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{284C0E0A-010B-45BF-8291-09D90A459B28}"" name=""Sharpness"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{284C0E0B-010B-45BF-8291-09D90A459B28}"" name=""Gamma"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E08}"" value=""0.979999999999999982236431605997"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{284C0E0D-010B-45BF-8291-09D90A459B28}"" name=""WhiteBalance"">" & vbLf & "                <element guid=""{B57D3001-0AC6-4819-A609-272A33140ACA}"" name=""Auto"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{8407E480-175A-498C-8171-08BD987CC1AC}"" name=""White Balance Green"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""64"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{6519038A-1AD8-4E91-9021-66D64090CC85}"" name=""White Balance Blue"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""154"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{6519038B-1AD8-4E91-9021-66D64090CC85}"" name=""White Balance Red"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""100"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{AB98F78D-18A6-4EB2-A556-C11010EC9DF7}"" name=""WhiteBalance Mode"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E06}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{284C0E0F-010B-45BF-8291-09D90A459B28}"" name=""Gain"">" & vbLf & "                <element guid=""{B57D3001-0AC6-4819-A609-272A33140ACA}"" name=""Auto"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E08}"" value=""32."" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{90D5702E-E43B-4366-AAEB-7A7A10B448B4}"" name=""Exposure"">" & vbLf & "                <element guid=""{B57D3001-0AC6-4819-A609-272A33140ACA}"" name=""Auto"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E08}"" value=""5."" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{65190390-1AD8-4E91-9021-66D64090CC85}"" name=""Auto"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""1"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{6519038C-1AD8-4E91-9021-66D64090CC85}"" name=""Auto Reference"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""128"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{90D57031-E43B-4366-AAEB-7A7A10B448B4}"" name=""Trigger"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enable"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{C3C9944A-E6F6-4E25-A0BE-53C066AB65D8}"" name=""Denoise"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{E33B9C58-0BF8-442D-8035-B4ABD7AF44AA}"" name=""Flip Horizontal"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enable"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""1"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{86D89D69-9880-4618-9BF6-DED5E8383449}"" name=""GPIO"">" & vbLf & "                <element guid=""{7D006621-761D-4B88-9C5F-8B906857A501}"" name=""GP Out"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E03}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{4F95A06D-9C15-407B-96AB-CF3FED047BA4}"" name=""Binning factor"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Value"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E06}"" value=""1"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{A3E64DA6-736A-489B-8425-04BD2B4AC57A}"" name=""IMX178 LLP Gain"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enabled"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""1"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{546541AD-C815-4D82-AFA9-9D59AF9F399E}"" name=""Highlight Reduction"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enable"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""1"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{3D505AC4-1A28-428B-83E5-85AA8EB441C1}"" name=""Tone Mapping"">" & vbLf & "                <element guid=""{B57D3001-0AC6-4819-A609-272A33140ACA}"" name=""Auto"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enable"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{BD2F432A-02C1-4F32-9AEB-687CA117D2E7}"" name=""Intensity"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E08}"" value=""0.5"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{D1451FED-C2D8-42CE-910B-2CB566836A77}"" name=""Global Brightness Factor"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E08}"" value=""0."" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{2CED6FD6-AB4D-4C74-904C-D682E53B9CC5}"" name=""Partial scan"">" & vbLf & "                <element guid=""{36EAA683-3321-44BE-9D73-E1FD4C3FDB87}"" name=""Auto-center"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""1"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{DC320EDE-DF2E-4A90-B926-71417C71C57C}"" name=""Strobe"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enable"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{7F7E24E3-7162-42EF-BF5D-99A359CB32F2}"" name=""Color Matrix"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enabled"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "            <item guid=""{124922E5-81C7-4587-867D-7BA16AF79079}"" name=""Auto Functions ROI"">" & vbLf & "                <element guid=""{B57D3000-0AC6-4819-A609-272A33140ACA}"" name=""Enabled"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E04}"" value=""0"" />" & vbLf & "                </element>" & vbLf & "                <element guid=""{93D840ED-B7B8-45FE-91E2-18E68C41AFC3}"" name=""Preset"">" & vbLf & "                    <itf guid=""{99B44940-BFE1-4083-ADA1-BE703F4B8E06}"" value=""2"" />" & vbLf & "                </element>" & vbLf & "            </item>" & vbLf & "        </vcdpropertyitems>" & vbLf & "    </device>" & vbLf & "</device_state>" & vbLf

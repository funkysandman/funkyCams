...
'
'
' Your driver's ID is ASCOM.test.Camera
'
...
<Guid("206993cd-9cb0-4daa-b14b-ec9b0b48dd00")>
<ClassInterface(ClassInterfaceType.None)>
Public Class Camera

    ' The Guid attribute sets the CLSID for ASCOM.test.Camera
    ' The ClassInterface/None addribute prevents an empty interface called
    ...
    '
    Friend Shared driverID As String = "ASCOM.test.Camera"
    Private Shared driverDescription As String = "test Camera"

...
namespace Photometrics
{
    namespace Pvcam
    {
        internal static class PVCAM64
        {
            ...
            [DllImport("Pvcam64.dll", EntryPoint = "pl_cam_register_callback",
            ExactSpelling = false)]
            ...
            [DllImport("Pvcam64.dll", EntryPoint = "pl_cam_register_callback_ex",
            ExactSpelling = false)]
            ...
            [DllImport("Pvcam64.dll", EntryPoint = "pl_cam_register_callback_ex2",
            ExactSpelling = false)]
            ...
            [DllImport("Pvcam64.dll", EntryPoint = "pl_exp_init_seq",
            ExactSpelling = false)]
            ...
            [DllImport("Pvcam64.dll", EntryPoint = "pl_exp_check_status",
            ExactSpelling = false)]
            ...
            [DllImport("Pvcam64.dll", EntryPoint = "pl_exp_uninit_seq",
            ExactSpelling = false)]

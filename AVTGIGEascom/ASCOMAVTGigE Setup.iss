...
; Generated by Sandy MacPherson on 6/10/2018 (UTC)
;
[Setup]
AppID={{6cf83c62-53fc-41a5-bcbb-95f7d8aea9a8}
AppName=ASCOM ASCOMAVTGigE Camera Driver
AppVerName=ASCOM ASCOMAVTGigE Camera Driver 1
AppVersion=1
...
OutputDir="."
OutputBaseFilename="ASCOMAVTGigE Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Camera\ASCOMAVTGigE"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Camera\ASCOMAVTGigE"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\sandy\Source\Repos\funkyCams\AVTGIGEascom\bin\debug\ASCOM.AVTGIGE.Camera.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\sandy\Source\Repos\funkyCams\AVTGIGEascom\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.AVTGIGE.Camera.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.AVTGIGE.Camera.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.AVTGIGE.Camera.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.AVTGIGE.Camera.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.AVTGIGE.Camera.dll"""; Flags: runhidden 64bit; Check: IsWin64

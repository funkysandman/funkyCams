...
{
    //
    // Your driver's DeviceID is ASCOM.Foculus.Camera
    //
    ...
    /// ASCOM Camera Driver for Foculus.
    /// </summary>
    [Guid("b97f41f4-c14f-4b2b-b441-8206f08b1d50")]
    ...
    //    //private  AxFGControlLib.AxFGControlCtrl myCam;
    //    //public  CameraWrapper()
    //    //{

    //    //    myCam = new AxFGControlLib.AxFGControlCtrl();
    //    //    myCam.CreateControl();
    //    //    myCam.Camera = 0;


    //    //}
    //    public void Acquisition(int x)
    //    {
    //        try
    //        { myCam.Acquisition = x; }
    ...
    //}
    public class Camerab : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.Foculus.Camera";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Camera Driver for Foculus.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Foculus"/> class.
        /// Must be public for COM registration.
        /// </summary>
        /// 
        //public frmAxFG myCam;
        private Thread myWrapperThread;

        public SetupDialogForm setupForm;
        /// <summary>
        /// reference to invisible camera control
        /// </summary>
        public Camera()
        {
            try
            {
                ...
                //    //camContainer = new frmAxFG();
                //    while (camwrap is null) { 
                //    Thread.Sleep(500);
                //}
                ////myCam.Camera = 0;
        ...
        public void SetupDialog()
        {
            ...
            //if (!axFGControlCtrl1.IsAccessible) { 
            //axFGControlCtrl1 = new AxFGControlLib.AxFGControlCtrl();
            //axFGControlCtrl1.CreateControl();
        ...
        //{
        //    camwrap.Acquisition(1);
        //}
        //public void stopAcquisition()
        //{
        //    camwrap.Acquisition(0);
        //}
        ...
        //private unsafe void axFGControlCtrl1_ImageReceived(object sender, AxFGControlLib._IFGControlEvents_ImageReceivedEvent e)
        //{
        ...
        //        int SizeX = myCam.SizeX;
        //        int SizeY = myCam.SizeY;
        //        int Size = SizeX * SizeY;
        //        int counter =0;

        //        {
        //            byte[] DataOrg;
        //            byte* pBuf = (byte*)(int)myCam.GetRawDataPointer();

        //            if (myCam.GetBitPerPixel() == 12 || myCam.GetBitPerPixel() == 16)
        //                Size = SizeX * SizeY * 2;
        //            else
        //                Size = SizeX * SizeY;

        //            DataOrg = new byte[Size];
        //            cameraImageArray = new int[cameraNumX, cameraNumY];
        //            Marshal.Copy(new IntPtr(pBuf), DataOrg, 0, Size);
        //            for (int x = 0; x < cameraNumX; x++)
        //            { 
        //                for (int y = 0; y < cameraNumY; y++)

        //                 {
        //                    cameraImageArray[x, y] = DataOrg[counter] + DataOrg[counter + 1]*256;
        //                    counter = counter + 2;
        //                  }
        //            }
        ...
        //   // m_nCount++;
        //   // string strMsg;
        //   // strMsg = String.Format("Frame {0}", m_nCount);
        //   //  labelCount.Text = strMsg;
        //}
        public int StartX
        {
            get
